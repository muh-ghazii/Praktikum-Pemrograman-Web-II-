<div class="container py-4" style="max-width:640px;">
    ...
    <h4 class="fw-bold mb-4" style="font-family:'Hanken Grotesk',sans-serif;">
        <i class="bi bi-plus-circle me-2" style="color:var(--primary)"></i>Tambah Buku
    </h4>
        ...
        <form action="/buku/store" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="judul"
                       class="form-control form-control-custom <?= $validation->hasError('judul') ? 'is-invalid' : '' ?>"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="penulis"
                       class="form-control form-control-custom <?= $validation->hasError('penulis') ? 'is-invalid' : '' ?>"
            ...
            <div class="mb-3">
                ...
                <input type="text" name="penerbit"
                       class="form-control form-control-custom <?= $validation->hasError('penerbit') ? 'is-invalid' : '' ?>"
            ...
            <div class="mb-4">
                ...
                <input type="number" name="tahun_terbit"
                       class="form-control form-control-custom <?= $validation->hasError('tahun_terbit') ? 'is-invalid' : '' ?>"
